...
public :
    ...
    void verifierEtChangmentBoublan();
...
private:
    vector <string> m_T;//le tableau principal
    vector <string> m_Ttempo;//le tableau temporaire
    vector <Element> m_TE;//ce tableau servira à creer la l'arbre
    vector <string> m_TOrdonnE;//ce tableau contien le valeur ordonnées
    int m_nbNiveau;
