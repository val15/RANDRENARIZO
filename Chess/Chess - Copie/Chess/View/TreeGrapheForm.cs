...
namespace Chess.View
{
  ...
  public partial class TreeGrapheForm : Form
  {
    ...
    public TreeGrapheForm(List<Node> tree)
    {
      ...
      _kingRoot  = _tree.FirstOrDefault(x => x.AssociatePawn?.Name == "King" && x.Level == 0);
    ...
    private void TreeGrapheForm_Load(object sender, EventArgs e)
    {
      ...
      */
      ...
      foreach (var item in _tree.Where(x=>x.AssociatePawn?.Name=="King" && x.Level == 1 && x.Location == "d2"))
      {
